...
test.describe('Role permission', async () => {
    ...
    test(`Org admin can edit their own CDE`, async ({ page, navigationMenu, cdePage, generateDetailsSection }) => {
    ...
    test(`Logged out cannot edit`, async ({ page, navigationMenu, cdePage, generateDetailsSection }) => {
