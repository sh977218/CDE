...
exports.parseFormElement = function (loincElements, fe, next) {
                    ...
                    if (existingForms.length === 0) {
                        ...
                        MigrationLoincModel.find({'loincId': loincElement['LOINC#']}).exec(function (e, innerFormLoincs) {
                            if (e) throw e;
                                ...
                                var innerForm = ult.createForm(innerFormLoinc, 'NLM', 'AHRQ');
                                exports.parseFormElement(innerFormLoinc['PANEL HIERARCHY']['PANEL HIERARCHY'].elements, innerForm.formElements[0].formElements, function () {
