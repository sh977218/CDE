...
async.forEachSeries(collections, function (collectionObj, doneOneCollection) {
    var collection = collectionObj.model;
    var recordsCount = 0;
    collection.distinct('stewardOrg.name', function (distinctError, orgs) {
