export type ORG_INFO = {
    orgName?: string;
    stewardOrgName: string;
    xml?: string;
    classificationOrgName: string;
    mapAllClassification?: string;
    classificationMap: { [key: string]: string };
    filter?: (contextName: string, b: string) => boolean;
    statusMapping: { [key: string]: string };
};
export const NCI_ORG_INFO_MAP: { [key: string]: ORG_INFO } = {
