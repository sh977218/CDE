...
export class CdeAppComponent implements OnInit {
    ...
    ngOnInit() {
        const description = '<div id="feedback-welcome"><div class="h3">Report a problem</div>' +
            '<p>What would you like to report?</p>' +
            '<textarea id="feedback-note-tmp"></textarea>' +
            '<br><br>' +
            '<button id="feedback-welcome-next" class="feedback-next-btn  btn btn-outline-dark">Next</button>' +
            '<div id="feedback-welcome-error">Please enter a description.</div><div class="feedback-wizard-close"></div></div>';

        const highlighter = '<div id="feedback-highlighter"><div class="h3">Report a problem</div>' +
            ...
            '<div class="feedback-buttons"><button id="feedback-highlighter-next"' +
            ' class="feedback-next-btn btn btn-outline-dark">Next</button>' +
            '<button id="feedback-highlighter-back" class="feedback-back-btn  btn btn-outline-dark">Back</button></div>' +
            '<div class="feedback-wizard-close"></div></div>';

        const overview = '<div id="feedback-overview"><div class="h3">Report a problem</div>' +
            '<div id="feedback-overview-description"><div id="feedback-overview-description-text">' +
            '<h3>Description</h3><div id="feedback-additional-none"><span>None</span></div></div></div>' +
            ...
            '<button id="feedback-overview-back" class="feedback-back-btn  btn btn-outline-dark">Back</button></div>' +
            '<div id="feedback-overview-error">Please enter a description.</div><div class="feedback-wizard-close"></div></div>';

        const submitSuccess = '<div id="feedback-submit-success"><div class="h3">Thank you!</div>' +
        ...
        const submitError = '<div id="feedback-submit-error"><div class="feedback-logo">Feedback</div>' +
