...
const cdeSteps: Array<any> = [
    ...
    },
    {
        ...
        content: 'The registration status represents the maturity level of an anchorId, with Standard and Preferred Standard being' +
    ...
    },
    {
        title: 'Discuss',
        anchorId: 'discussBtn',
        content: 'With an account, anyone can interactively discuss an anchorId. Users can reply to comment or resolve them.'
    }
];
