...
export class DeCompletionService {
    ...
    constructor(private alert: AlertService, private elasticService: ElasticService, private http: HttpClient) {
        ...
        this.searchTerms
            ...
            .subscribe(res => {
                ...
                if (tinyIdList && tinyIdList.length > 0) {
                    this.http.get<any[]>('/server/de/list/' + tinyIdList).subscribe(
                        result => {
