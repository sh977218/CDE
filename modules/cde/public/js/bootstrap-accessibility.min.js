...
! function ($) {
    ...
    $.fn.popover.Constructor.prototype.setContent = function () {
        ...
        hideTooltip.apply(this, arguments), removeMultiValAttributes(this.$element, "aria-describedby", this.tip().attr("id"))
    }, $(".modal-dialog").attr({
        role: "document"
    });
    ...
    $.fn.modal.Constructor.prototype.hide = function () {
        ...
        modalhide.apply(this, arguments), modalOpener.focus()
    };
    ...
    $.fn.tab.Constructor.prototype.activate = function (element, container) {
        ...
        $active.find("[data-toggle=tab]").attr({
            ...
            "aria-hidden": !0,
            tabIndex: "-1"
        }), tabactivate.apply(this, arguments), element.addClass("active"), element.find("[data-toggle=tab]").attr({
            tabIndex: "0",
            "aria-selected": !0,
            "aria-expanded": !0
