systemModule.controller('CreateCdeCtrl', ['$scope', '$window', '$timeout', '$modal', 'DataElement', 'Elastic', 'userResource', function($scope, $window, $timeout, $modal, DataElement, Elastic, userResource) {
