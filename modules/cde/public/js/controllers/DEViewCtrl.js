        ...
        function ($scope, $routeParams, $window, $http, $timeout, DataElement, DataElementTinyId,
            ...
            $scope.tabs = {
                ...
                forms: {
                    ...
                    select: function () {
                        setCurrentTab();
                        $scope.formsCtrlLoadedPromise.promise.then(function () {
                            $scope.$broadcast('loadLinkedForms');
                        });
                    },
                    show: false,
                    hideable: true
                ...
                derivationRules: {
                    ...
                    select: function () {
                        setCurrentTab();
                        $scope.derRulesCtrlLoadedPromise.promise.then(function () {
                            $scope.$broadcast('loadDerivationRules');
                        });
                    },
                    show: false,
                    hideable: true
                ...
                mlt: {
                    ...
                    select: function () {
                        setCurrentTab();
                        $scope.mltCtrlLoadedPromise.promise.then(function () {
                            $scope.$broadcast('loadMlt');
                        });
                    },
                    show: false,
                    hideable: true
                ...
                history: {
                    ...
                    select: function () {
                        setCurrentTab();
                        $scope.historyCtrlLoadedPromise.promise.then(function () {
                            $scope.$broadcast('loadPriorCdes');
                        });
                    },
                    show: false,
                    hideable: true
                ...
                forks: {
                    ...
                    select: function () {
                        ...
                        $scope.forkCtrlLoadedPromise.promise.then(function () {
                            $scope.$broadcast('loadForks');
                        });
                    },
                    show: false,
                    hideable: true
            ...
            $scope.loadValueSet = function () {
                ...
                if (dec && dec.conceptualDomain && dec.conceptualDomain.vsac) {
                    ...
                    $http({
                        method: "GET",
                        url: "/vsacBridge/" + dec.conceptualDomain.vsac.id
