...
//this.classifyElement = function(err, cde) {
...
//    }
//
//    if (action === classificationShared.actions.create) classificationShared.addCategory(steward.object, body.categories, classification.cdeClassification.saveCdeClassif);
