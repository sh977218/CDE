...
config.elasticBoardIndexUri = config.elastic.uri + "/" + config.elastic.boardIndex.name + "/";
config.elasticBoardRiverUri = config.elastic.uri + "/_river/" + config.elastic.boardIndex.name;
