                 ...
                 $interval, $window, screenSize, OrgHelpers, QuickBoard, $rootScope, $route, LoginRedirect)
{
    ...
    $rootScope.$on("$routeChangeSuccess", function(event, currentRoute, previousRoute){
        ...
        $rootScope.pageMeta.keywords = 'cde, common data element, form, protocol, protocol form, crf, case report form, promis, neuro-qol, phenx, ahrq, ninds,' +
            ' value set, repository, nih, nlm, national institutes of health, national library of medicine';
