    ...
    projects: [
        {
            ...
            name: 'CDE-e2e',
            use: {...devices['Desktop Chrome'], ignoreHTTPSErrors: true, timezoneId: 'America/New_York',},
            fullyParallel: true,
        },
        {
            timeout: 300 * 1000,
            ...
            name: 'CDE-oneTest',
            use: {
                ...devices['Desktop Chrome'], ignoreHTTPSErrors: true, timezoneId: 'America/New_York',
            },
            grep: [/@oneTest/],
            fullyParallel: true,
        },
