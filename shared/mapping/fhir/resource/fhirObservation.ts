...
export function observationComponentFromForm(
    fe: FormElement,
    getDisplay: GetDisplay,
    observationComponent?: FhirObservationComponent | Partial<FhirObservationComponent>
): Promise<FhirObservationComponent> {
    const ids = getIds(fe) || [];
...
export function observationFromForm(
    fe: FormElement,
    getDisplay: GetDisplay,
    encounter?: FhirEncounter,
    patient?: FhirPatient
): Promise<FhirObservation> {
    return observationComponentFromForm(fe, getDisplay, newObservation(patient, encounter)).then(
