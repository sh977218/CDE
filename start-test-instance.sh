...
gradle -b test/selenium/build.gradle -PhubUrl=$HUB_URL -PtestUrl=$TEST_URL -Pbrowser=chrome -PforkNb=2 -Ptimeout=8 test --tests *checkOnlyShowingDefaultAttachmentForm* &
export NODE_ENV=test
node $NODE_LOC/app > test-console.o