...
public class CdeEditTest extends NlmCdeBaseTest {
    ...
    public void editCde() {
        ...
        textPresent(cdeName + "[name change number 1]", By.xpath("//*[@id='historyCompare_Names_0']/div[contains(@class,'left')]//div[contains(@class,'designation')]"));
        textPresent(cdeDefinitionChange, By.xpath("//*[@id='historyCompare_Names_0']/div[contains(@class,'left')]//div[contains(@class,'definition')]"));
