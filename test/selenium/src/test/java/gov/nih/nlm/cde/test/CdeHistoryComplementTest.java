...
public class CdeHistoryComplementTest extends NlmCdeBaseTest {
    ...
    public void cdeHistoryComplement() {
        ...
        textPresent("Alternative Name 1", By.xpath("//*[@id='historyCompareLeft_Naming_0']//div[contains(@class,'designation')]"));
        textPresent("Alternative Definition 1", By.xpath("//*[@id='historyCompareLeft_Naming_0']//div[contains(@class,'definition')]"));
        textPresent("Code Name 1", By.xpath("//*[@id='historyCompareLeft_Data Element Concepts_0']//div[contains(@class,'name')]"));
        textPresent("Code ID 1", By.xpath("//*[@id='historyCompareLeft_Data Element Concepts_0']//div[contains(@class,'originId')]"));
        ...
        clickElement(By.id("history_tab"));
        selectHistoryAndCompare(1, 2);
        textPresent("Origin 1", By.xpath("//*//*[@id='historyCompareLeft_Identifiers_0']//*[contains(@class,'source')]"));
        textPresent("Identifier 1", By.xpath("//*[@id='historyCompareLeft_Identifiers_0']//*[contains(@class,'id')]"));
        textPresent("Version 1", By.xpath("//*[@id='historyCompareLeft_Identifiers_0']//*[contains(@class,'version')]"));
    }
