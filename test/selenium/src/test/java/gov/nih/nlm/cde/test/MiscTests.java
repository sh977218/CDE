...
public class MiscTests extends NlmCdeBaseTest {
    ...
    public void checkSchemas() {
        ...
        Assert.assertTrue(get(baseUrl + "/schema/form").asString().contains("{\"title\":\"Form\",\"type\":\"object\",\"properties\":{\"elementType\":{\"type\":\"string\",\"enum\":[\"form\"],\"default\":\"form\"},\"tinyId\":{\"type\":\"string\"},\"designations\":{\"type\":\"array\",\"items\":{\"title\":\"itemOf_naming\",\"type\":\"object\",\"properties\":{\"designation\":"));
    }
}
