...
public class TourTest extends NlmCdeBaseTest {
    ...
    private String[] steps = new String[]{
            ...
            "Boards allow registered users to group CDEs or Forms.",
            ...
            "By default, only Qualified and above statuses will be returned. This can be changed",
            ...
            "If a CDE is used on public boards, the boards will be shown in this section.",
            "This section lists CDEs that are most similar to the CDE currently viewed.",
            "If a CDE is used on Forms, they will be displayed here. ",
