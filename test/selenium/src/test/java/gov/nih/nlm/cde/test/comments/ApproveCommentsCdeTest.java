...
public class ApproveCommentsCdeTest extends NlmCdeBaseTest {
    @Test
    public void approveCdeCommentsTest() {
    ...
    @Test(dependsOnMethods = {"approveCdeCommentsTest"})
    public void declineCdeCommentTest() {
