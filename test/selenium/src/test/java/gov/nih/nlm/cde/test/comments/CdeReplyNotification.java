...
public class CdeReplyNotification extends NlmCdeBaseTest {
    ...
    public void updateNotificationView() {
        ...
        Assert.assertEquals(taskItem.getCssValue("background-color"), "rgb(209, 236, 241, 1)");
        ...
        Assert.assertEquals(taskItem.getCssValue("background-color"), "rgb(255, 255, 255, 1)");
    }
