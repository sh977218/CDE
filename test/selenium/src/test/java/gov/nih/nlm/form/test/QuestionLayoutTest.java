...
public class QuestionLayoutTest extends QuestionTest {
    ...
    public void questionsLayoutTest() {
        ...
        clickElement(By.xpath("//*[@id='section_1']//*[contains(@class,'editIconDiv')]//*[contains(@class,'fa-check')]"));
        textNotPresent(sec2);
        clickElement(By.xpath("//*[@id='section_0']//*[contains(@class,'editIconDiv')]//i[contains(@class,'fa-trash-o')]"));
        clickElement(By.xpath("//*[@id='section_0']//*[contains(@class,'editIconDiv')]//*[contains(@class,'fa-check')]"));
        textNotPresent(sec1);
