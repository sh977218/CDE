...
public class FormForEdit extends NlmCdeBaseTest {
    ...
    public void forEditByTinyIdVersion() {
        String resp = get(baseUrl + "/server/form/forEdit/XJzVz1TZDe/version/v1.0 2014Jul2").asString();
    ...
    public void draftSave() {
        ...
        given().contentType(ContentType.JSON).cookie(myCookie)
                ...
                .put(baseUrl + "/server/form/draft/my9q6NmEb").then().statusCode(400);
    }

    @Test
    public void originalSource() {
        get(baseUrl + "/server/form/originalSource/sourceName/tinyId").then().statusCode(404);
    }
