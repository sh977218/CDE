...
public class FhirQuestionnaireExport extends BaseFormTest {
    ...
    public void questionnaireExport() {
        ...
        String response = get(baseUrl + "/server/form/formById/58497234bb2d48e00466acd7?subtype=fhirQuestionnaire").asString();
        ...
        String responseValidate = get(baseUrl + "/server/form/formById/58497234bb2d48e00466acd7?subtype=fhirQuestionnaire&validate").asString();
