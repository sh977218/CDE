...
public class FormXMLExportTest extends NlmCdeBaseTest {
    ...
    public void formXmlExport() {
        ...
        String resp = get(baseUrl + "/server/form/form/sdsflijkfsd?type=xml").asString();
        Assert.assertTrue(resp.contains("ctepCurator"));
    }

    @Test
    public void getFormNih() {
        String resp = get(baseUrl + "/server/form/formById/58caa836453619ab06d913b3?type=xml").asString();
