...
public class SkipLogicDateTest extends BaseFormTest {
    ...
    public void skipLogicDateTest() {
        ...
        editSkipLogic(inputXpath1, 2, true, "Unexpected number of tokens in expression 1");
        editSkipLogic(inputXpath1, 1, true, "Unexpected number of tokens in expression 2");
        editSkipLogic(inputXpath1, 1, true, "\"{{MM/DD/YYYY}}\" is not a valid date for \"Indicate date of reference scan\".");
        ...
        goToFormByName(formName);
        findElement(By.xpath("//*[*[normalize-space()='Indicate date of reference scan']]//*[normalize-space(text())='If 10/11/2016:']"));
        findElement(By.xpath("//*[*[normalize-space()='Indicate date of reference scan']]//*[normalize-space(text())='If more than 10/11/2016:']"));
        findElement(By.xpath("//*[*[normalize-space()='Indicate date of reference scan']]//*[normalize-space(text())='If less than 10/11/2016:']"));
