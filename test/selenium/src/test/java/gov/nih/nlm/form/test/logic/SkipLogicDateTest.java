...
public class SkipLogicDateTest extends BaseFormTest {
    ...
    public void skipLogicDateTest() {
        ...
        textPresent("left eye");
                ...
                clickElement(By.id("selectRenderButton"));                clickElement(By.xpath("(//*[@id='selectRenderButton']/following-sibling::div)/button[normalize-space(text()) = 'Printable Logic:']/input"));
