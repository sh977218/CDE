...
public interface MAP_HELPER {
    ...
    Map<String, String> SWAGGER_API_TYPE = new HashMap<String, String>() {
        {
            put("cdeTinyId", "operations-CDE-get_server_cde_de__tinyId_");
            put("cdeTinyIdVersion", "operations-CDE-get_server_cde_de__tinyId__version__version_");
            put("formTinyId", "operations-Form-get_server_form_form__tinyId_");
            put("formTinyIdVersion", "operations-Form-get_server_form_form__tinyId__version__version_");
        }
    };
