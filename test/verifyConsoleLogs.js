...
let expectedContent = {
    ...
    "latestComments": "Failed to load resource: the server responded with a status of 401 (Unauthorized)",
    ...
    "publishForm": "Failed to load resource: the server responded with a status of 401",
    ...
    "userEmail": "myDrafts - Failed to load resource: the server responded with a status of 401",
    "viewingHistory": "myDrafts - Failed to load resource: the server responded with a status of 401 (Unauthorized)",
